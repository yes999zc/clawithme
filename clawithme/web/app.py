...
║      _                _ _   _                                                ║
║     | |              (_) | | |                                               ║
║  ___| | __ ___      ___| |_| |__  _ __ ___   ___                             ║
║ / __| |/ _` \ \ /\ / / | __| '_ \| '_ ` _ \ / _ \                            ║
║| (__| | (_| |\ V  V /| | |_| | | | | | | | |  __/                            ║
║ \___|_|\__,_| \_/\_/ |_|\__|_| |_|_| |_| |_|\___|                            ║
║                                                                              ║
║                   🔍  Username → Identity Panorama  v0.1                     ║
║                                                                              ║
║    ┌─────────────────────┬─────────────────────┬────────────────────────┐    ║
║    │  📡 3,031 Sites     │  ⚡ 14s Cold Start   │  🇨🇳 16 CN Platforms   │    ║
║    │  🔧 49 Extractors   │  🧠 9 Detection Eng  │  📋 4 Report Formats  │    ║
║    │  🔗 7-Signal Corr   │  🤖 LLM Verification │  🔓 Leak DB (Cav+HIBP)│    ║
║    └─────────────────────┴─────────────────────┴────────────────────────┘    ║
║                                                                              ║
║       Probe → Extract → Correlate → Verify → Report                          ║
║                                                                              ║
╚══════════════════════════════════════════════════════════════════════════════╝"""
