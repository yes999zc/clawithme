...
_STRINGS = {
    "zh": {
        ...
        "no_sites": "未发现站点。",
        "no_profiles": "未提取到资料。",
        "no_clusters": "未发现跨平台身份关联。",
        "cluster_label": "关联组",
        "standalone_heading": "独立账号",
        "standalone_desc": "以下账号未发现与其他平台的关联证据，各自独立。",
    ...
    "en": {
        ...
        "no_clusters": "No cross-platform identity matches found.",
        "cluster_label": "Match",
        "standalone_heading": "Standalone Profiles",
        "standalone_desc": "These profiles show no evidence of cross-platform association.",
